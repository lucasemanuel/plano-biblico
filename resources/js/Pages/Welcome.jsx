                ...
                <section>
                    <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28 lg:h-[40rem]">
                        ...
                        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex justify-center">
                            <img className="animation w-80" src="images/bible.svg" alt="hero image" />
                        </div>
                    </div>
                </section>
                <footer className="bg-gray-50">
                    <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10 lg:h-80 flex justify-center items-center">
